...
public class ItemAssistant {
    ...
    public void sendWeapon(int Weapon, String WeaponName) {
        ...
        } else if (WeaponName.endsWith("whip") || WeaponName.endsWith("vine")) {
        ...
        } else if (WeaponName2.contains("longsword") || WeaponName2.contains("machete")) {
        ...
        } else if (WeaponName2.startsWith("dagger") || WeaponName2.contains("sword") || WeaponName2.contains("xil-ak")) {
    ...
    public void getRequirements(String itemName, int itemId) {
        c.runecraftingLevelReq = c.attackLevelReq = c.defenceLevelReq = c.strengthLevelReq = c.rangeLevelReq = c.magicLevelReq = c.prayerLevelReq = c.slayerLevelReq = 0;
        ...
        if (itemName.contains("steel")) {
            if (!itemName.contains("knife") && !itemName.contains("arrow") && !itemName.contains("dart") && !itemName.contains("javelin") && !itemName.contains("thrownaxe")) {
                c.attackLevelReq = c.defenceLevelReq = 5;
            }
            return;
        }
        if (itemName.contains("black")) {
            if (!itemName.contains("hide") && !itemName.contains("knife") && !itemName.contains("dart") && !itemName.contains("javelin") && !itemName.contains("thrownaxe") && !itemName.contains("robe")) {
        ...
        if (itemName.contains("dragon platelegs") || itemName.contains("dragon plateskirt")) {
        ...
        if (itemName.contains("guthix")) {
            if (!itemName.contains("staff") || !itemName.contains("cape"))
                c.defenceLevelReq = 40;
        }
    ...
    public boolean wearItem(int wearID, int slot) {
        ...
        synchronized (c) {
            ...
            if (c.playerItems[slot] == (wearID + 1)) {
                ...
                if (wearID == 2665 || wearID == 1037 || wearID == 4166 || wearID == 6326) {
                    targetSlot = 0;
                }
                ...
                if (Config.itemRequirements) {
                    if (targetSlot == 10 || targetSlot == 8 || targetSlot == 11 || targetSlot == 12 || targetSlot == 13 || targetSlot == 6 || targetSlot == 7 || targetSlot == 5 || targetSlot == 4 || targetSlot == 2 || targetSlot == 1 || targetSlot == 0 || targetSlot == 9 || targetSlot == 10) {
    ...
    public void addItem3(int id, int amount) {
        addItem(id, amount);
        if (amount > 1 && !Item.itemStackable[id]) {
    ...
    public void deleteArrow() {
        synchronized (c) {
            if (c.playerEquipment[c.playerCape] == 3280 && Misc.random(5) != 1)
                return;
    ...
    public void dropArrowNpc() {
        if (c.playerEquipment[c.playerCape] == 3280)
            return;
    ...
    public void dropArrowPlayer() {
        ...
        if (c.playerEquipment[c.playerCape] == 5607)
            return;
        if (c.playerEquipment[c.playerCape] == 3280)  // Replace ava With the Ava Accumulator Id.
        {
