    ...
    public void processPacket(final Client c, int packetType, int packetSize) {
        ...
        switch (packetType) {
            ...
            case ATTACK_NPC:
                ...
                if (c.getCombat().correctBowAndArrows() < c.playerEquipment[c.playerArrows] && Config.CORRECT_ARROWS && usingBow && !c.getCombat().usingCrystalBow() && c.playerEquipment[c.playerWeapon] != 837 && c.playerEquipment[c.playerWeapon] != 767) {
                ...
                if (c.playerEquipment[c.playerWeapon] == 837 && !c.getCombat().properBolts()) {
                    c.sendMessage("You must use bolts with a crossbow.");
                    c.stopMovement();
                    c.getCombat().resetPlayerAttack();
                    return;
                }
                if (c.playerEquipment[c.playerWeapon] == 767 && !c.getCombat().properBolts()) {
                    c.sendMessage("You must use bolts with a crossbow.");
                    c.stopMovement();
                    c.getCombat().resetPlayerAttack();
                    return;
            ...
            case FIRST_CLICK:
                ...
                if (c.goodDistance(NPCHandler.npcs[c.npcClickIndex].getX(), NPCHandler.npcs[c.npcClickIndex].getY(), c.getX(), c.getY(), NPCSize.getNPCSize(c.npcType))) {
