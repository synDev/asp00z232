...
public class Thieving extends SkillHandler {
    ...
    public static void stealFromStall(final Client c, final int id, int amount, int xp, int level, final int i, final int x, final int y, final int face) {
        ...
        if (c.playerLevel[c.playerThieving] >= level) {
            if (c.getItems().addItem(id, amount)) {
                ...
                c.getPA().addSkillXP(xp * Config.THIEVING_XP, c.playerThieving);
    ...
    private static int[][] pickpocket = {
            {1, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {2, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {3, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {4, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {5, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {6, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {3223, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {3224, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {3226, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {3227, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {3915, 1, 8, 1 + Misc.random(3), 3, 10, 20, 30},
            {7, 10, 15, 5 + Misc.random(13), 3, 20, 30, 40},
            {9, 40, 47, 36 + Misc.random(32), 3, 50, 60, 70},
            {15, 25, 26, 17 + Misc.random(20), 3, 35, 45, 55},
            {20, 70, 151, 100 + Misc.random(250), 8, 80, 90, 99},
            {2256, 70, 151, 50 + Misc.random(150), 8, 80, 90, 99},
            {21, 80, 275, 100 + Misc.random(250), 8, 90, 95, 99},
            {23, 55, 84, 40 + Misc.random(120), 7, 65, 75, 85},
            {26, 55, 84, 40 + Misc.random(120), 7, 65, 75, 85},
            {18, 25, 26, 17 + Misc.random(20), 3, 35, 45, 55},
            {3225, 10, 15, 5 + Misc.random(13), 3, 20, 30, 40},
    ...
    private static void completeThieve(final Client c, final int i) {
        ...
        if (chance == 1) {
            ...
            if (c.playerLevel[c.playerAgility] >= pickpocket[i][7]) {
                loot = pickpocket[i][4] * 4;
                message = "You steal a quadrouple loot from the " + Server.npcHandler.getNpcListName(pickpocket[i][0]) + "!";
            }
        }
        ...
        CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
                ...
                c.getPA().addSkillXP(pickpocket[i][2] * Config.THIEVING_XP, 17);
