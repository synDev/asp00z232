...
public class SmithingInterface {
    ...
    private static void makeRuneInterface(Client c) {
        ...
        c.getPA().sendFrame126(threeb + "3 Bars" + threeb, 1126);
        ...
        c.getPA().sendFrame126(GetForlvl(89, c) + "Bolts" + GetForlvl(4, c), 1107);
        ...
        c.getPA().sendFrame126(GetForlvl(86, c) + "Halberd" + GetForlvl(1, c), 1091);
        c.getPA().sendFrame34(1213, 0, 1119, 1); //dagger
        c.getPA().sendFrame34(3202, 0, 1120, 1); //Halberd
    ...
    private static void makeAddyInterface(Client c) {
        ...
        c.getPA().sendFrame126(GetForlvl(74, c) + "Bolts" + GetForlvl(4, c), 1107);
        ...
        c.getPA().sendFrame126(GetForlvl(71, c) + "Halberd" + GetForlvl(1, c), 1091);
        c.getPA().sendFrame34(1211, 0, 1119, 1); //dagger
        c.getPA().sendFrame34(3200, 0, 1120, 1); //Halberd
    ...
    private static void makeMithInterface(Client c) {
        ...
        c.getPA().sendFrame126(GetForlvl(54, c) + "Bolts" + GetForlvl(4, c), 1107);
        ...
        c.getPA().sendFrame126(GetForlvl(51, c) + "Halberd" + GetForlvl(1, c), 1091);
        c.getPA().sendFrame34(1209, 0, 1119, 1); //dagger
        c.getPA().sendFrame34(3198, 0, 1120, 1); //Halberd
    ...
    private static void makeSteelInterface(Client c) {
        ...
        c.getPA().sendFrame126(GetForlvl(34, c) + "Bolts" + GetForlvl(4, c), 1107);
        ...
        c.getPA().sendFrame126(GetForlvl(31, c) + "Halberd" + GetForlvl(1, c), 1091);
        ...
        c.getPA().sendFrame34(3194, 0, 1120, 1);
    ...
    private static void makeIronInterface(Client c) {
        ...
        c.getPA().sendFrame126(GetForlvl(19, c) + "Bolts" + GetForlvl(4, c), 1107);
        ...
        c.getPA().sendFrame126(GetForlvl(16, c) + "Halberd" + GetForlvl(1, c), 1091);
        c.getPA().sendFrame34(1203, 0, 1119, 1);
        c.getPA().sendFrame34(3192, 0, 1120, 1);
    ...
    private static void makeBronzeInterface(Client c) {
        ...
        c.getPA().sendFrame126(GetForlvl(1, c) + "Halberd" + GetForlvl(1, c), 1091);
        c.getPA().sendFrame34(1205, 0, 1119, 1);
        c.getPA().sendFrame34(3190, 0, 1120, 1);
