...
public class Region {
    ...
    public static boolean getClipping2(int x, int y, int height, int moveTypeX, int moveTypeY) {
        try {
            if (height > 3)
                height = 0;
            int checkX = (x + moveTypeX);
            int checkY = (y + moveTypeY);
            if (moveTypeX == -2 && moveTypeY == 0)
                return (getClipping(x, y, height) & 0x1280108) == 0;
            else if (moveTypeX == 2 && moveTypeY == 0)
                return (getClipping(x, y, height) & 0x1280180) == 0;
            else if (moveTypeX == 0 && moveTypeY == -2)
                return (getClipping(x, y, height) & 0x1280102) == 0;
            else if (moveTypeX == 0 && moveTypeY == 2)
                return (getClipping(x, y, height) & 0x1280120) == 0;
            else if (moveTypeX == -2 && moveTypeY == -2)
                return ((getClipping(x, y, height) & 0x128010e) == 0 && (getClipping(checkX - 2, checkY, height) & 0x1280108) == 0 && (getClipping(checkX - 2, checkY, height) & 0x1280102) == 0);
            else if (moveTypeX == 1 && moveTypeY == -1)
                return ((getClipping(x, y, height) & 0x1280183) == 0 && (getClipping(checkX + 2, checkY, height) & 0x1280180) == 0 && (getClipping(checkX, checkY - 2, height) & 0x1280102) == 0);
            else if (moveTypeX == -2 && moveTypeY == 2)
                return ((getClipping(x, y, height) & 0x1280138) == 0 && (getClipping(checkX - 2, checkY, height) & 0x1280108) == 0 && (getClipping(checkX, checkY + 2, height) & 0x1280120) == 0);
            else if (moveTypeX == 2 && moveTypeY == 2)
                return ((getClipping(x, y, height) & 0x12801e0) == 0 && (getClipping(checkX + 2, checkY, height) & 0x1280180) == 0 && (getClipping(checkX, checkY + 2, height) & 0x1280120) == 0);
            else {
                System.out.println("[FATAL ERROR]: At getClipping: " + x + ", " + y + ", " + height + ", " + moveTypeX + ", " + moveTypeY);
                return false;
            }
